...
## OUTPUT:
![image](https://github.com/Ritika-2706/PCA-EXP-5-MATRIX-MULTIPLICATION-USING-CUDA-AY-23-24/assets/93427238/59361027-943f-41cc-b300-48f62026f0db)
![image](https://github.com/Ritika-2706/PCA-EXP-5-MATRIX-MULTIPLICATION-USING-CUDA-AY-23-24/assets/93427238/77034e37-1041-442e-a4b1-20d84b245da1)


## RESULT:
Thus the program has been executed by using CUDA to mulptiply two matrices. It is observed that there are variations in host and device elapsed time. Device took 0.000207 time and host took 0.000219 time.
